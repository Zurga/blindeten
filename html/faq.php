...
<div class="content">
	...
	<div class="maincontent">
		...
		<br>
		<p id= "cancel" class="hidden" style ="display:none">Ga dan naar de pagina "mijn reserveringen" klik op de link waar u reservering staat en vervolgens op cancel.</p>
		...
		<br>
		<p id="need_account" class="hidden" style = "display:none">Ja dit is nodig. Zo kunnen wij u een bevestigingsmail sturen en u naam doorgeven voor de reservering.</p>
		...
		<br>
		<p id="nobody_on_table" class="hidden" style="display:none">Dan kunt u gerust alleen eten. U krijgt echter geen tweede bevestigingsmail.</p>
		...
		<br>
		<p id="add_restaurant" class="hidden" style="display:none">U kunt ons een mailtje sturen en dan zullen wij contact met u opnemen.</p>
