...
<div class="content">
	<div class="maincontent">
		...
		<p>Naam:'. echo $restaurant->name; .'</p>
		<p>URL:'.echo $restaurant->url; .'</p>
		<p>Aantal tafels:'. echo $restaurant->tables; .'</p>
		<p>Adres:'. echo $restaurant->street; echo $restaurant->number; echo $restaurant->zipcode; echo $restaurant->city; .'</p>
		<p><a href="/account/edit.php" title="Gegevens wijzigen">Gegevens wijzigen</a>
		<br>		
		<a href="wachtwoordveranderen.php" title="Wachtwoord veranderen">Wachtwoord veranderen</a>
		</p>		
