	...
	<div class="maincontent">
		...
		<form id ="form" name= "register" action='register' method='post'>
			...
			<fieldset id="inputs" method='post'>
				<input id="name" name="input[name]" type="text" placeholder="<?php echo $name; ?>" required>  
				<br>
				<br>
				<input id="surname" name="input[surname]" type="text" placeholder="<?php echo $surname; ?>" required>
				<br>
				<br>
				<input id="email" name="input[email]" type="text" placeholder="<?php echo $email; ?>" required>   
				<br>
				<br>
				<input id="city" name="input[city]" type="text" placeholder="<?php echo $city; ?>" required> 
				<br>
				<br>
				...
				<br>
				<br>
				<input id="day" name="input[day]" type="day" size="4" maxlength="2" min="1" max="31" placeholder="<?php echo $day; ?>" required>
				<input id="month" name="input[month]" type="text" size="6" maxlength="2" min="01" max="12" placeholder="<?php echo $month; ?>" required>
				<input id="year" name="input[year]" type="year" size="4" maxlength="4" min="1915" max="1997" placeholder="<?php echo $year; ?>" required>
				<br>
				<br>
