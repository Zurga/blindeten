	...
	<div class="maincontent">
		...
		<form id ="form" name= "register" action='register' method='post'>
			...
			<fieldset id="inputs" method='post'>
				<input id="name" name="input[name]" type="text" placeholder="Voornaam" value = data["name"] required>  
				<br>
				<br>
				<input id="surname" name="input[surname]" type="text" placeholder="Achternaam" value = data["surname"] required>
				<br>
				<br>
